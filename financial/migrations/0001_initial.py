    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Vigente', 'Current'), ('Expirando', 'Expiring'), ('Vencido', 'Defeated')], max_length=20, verbose_name='Status do contrato')),
                ('expiration_alert', models.PositiveSmallIntegerField(help_text='Dias antes do vencimento do contrato que deverá alertar', verbose_name='Alerta de vencimento')),
